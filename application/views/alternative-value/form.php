		...
		<div class="row animated fadeIn">
			<div class="col-xs-12">
				<div class="page-title-box">
					<h4 class="page-title">Tambah Data Nilai Alternatif</h4>
					<ol class="breadcrumb p-0 m-0">
						<li>
							<a href="#">Master Data</a>
						</li>
						<li>
							<a href="<?php echo site_url('/alternativevalue'); ?>">Data Nilai Alternatif</a>
						</li>
						<li class="active">
							...
							<form method="post" class="form-horizontal">
								<div class="row">
									<div class="col-md-12">
										...
										<div class="form-group row">
											<label class="control-label col-md-2">Nama Alternatif
												<span class="text-danger">*</span></label>
											<div class="col-md-10">
									...
									<div class="form-group row">
										...
										<div class="col-md-10">
											...
											foreach ($criterias as $value) {
												?>
												<?php
												if (count($value['sub_criterias']) > 0) {
													?>
